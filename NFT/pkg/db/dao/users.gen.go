...
func newUser(db *gorm.DB) user {
	...
	_user.EthereumAddress = field.NewString(tableName, "ethereum_address")
...
func (u *user) updateTableName(table string) *user {
	...
	u.EthereumAddress = field.NewString(table, "ethereum_address")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["ethereum_address"] = u.EthereumAddress
}
